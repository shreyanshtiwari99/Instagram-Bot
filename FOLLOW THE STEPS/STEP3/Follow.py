...
print("\n")
print("WARNING !! THIS PROGRAM MUST BE EXECUTED COMPLETELY. DO NOT STOP THE PROCESS IN BETWEEN OR THE FOLLOWED ACCOUNTS WILL NOT GET ENTERED IN THE ACCOUNTS FOLLOWED TEXT FILE. END THE PROGRAM ONLY IF YOU DONT CARE ABOUT THE LIST OF ACCOUNTS BEING FOLLOWED")
print("\n")
...
numPosts = input("Enter the number of accounts you want to target for each hashtag  : ")
print("NUMBER OF ACCOUNTS TO BE TARGETTED : ", numPosts)
...
def likephoto(amount):
    ...
    while i <= amount:
        ...
        if(driver.find_element_by_xpath("/html/body/div[5]/div[2]/div/article/header/div[2]/div[1]/div[1]/span/a").get_attribute('innerHTML') != user_id):
            print("Username is not yours, entered first IF condition")
            btn_value = driver.find_element_by_class_name("sqdOP").get_attribute('innerHTML')#followbtn
            ...
            if(btn_value =="Follow" and like_btn.get_attribute("aria-label")=="Like"):
                try:
                        print("Following...")
                        f = open("AccountsFollowed.txt", "a")
                        print("File opened")
                        driver.find_element_by_xpath("/html/body/div[5]/div[2]/div/article/header/div[2]/div[1]/div[2]/button").click()#clickfollowbtn
                        print("Clicked followbtn")
                        ...
                        print("Comment done!")
                        print("ACCOUNT FOLLOWED : " +driver.find_element_by_xpath("/html/body/div[5]/div[2]/div/article/header/div[2]/div[1]/div[1]/span/a").get_attribute('innerHTML')+ "\n" )
                        

                        sleep(random.randint(3,6))

  
                        f.write(driver.find_element_by_xpath("/html/body/div[5]/div[2]/div/article/header/div[2]/div[1]/div[1]/span/a").get_attribute('innerHTML')+ "\n" )
